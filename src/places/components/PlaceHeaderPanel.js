...
export class PlaceHeaderPanel extends React.Component<void, Props, void> {
  ...
  render() {
    ...
    const PlaceIdArea = () => {
      if (user.isAdmin) {
        return (<b><br/>
          <a target='_blank' href={'https://apis.lightpace.com/#!/shops/' + place._id}>{place._id}</a><br/>
      ...
      <div className='row' style={{backgroundColor: '#FBFAFC', border: 'solid 1px #F2F2F2'}}>
        <div className='col-md-10 col-md-offset-1'>
          ...
          <div style={{float:'right',margin:'-50px 0px 0px 0px',width:'auto'}}>
            ...
            <div className='fb-share-button' data-href={'https://www.lightpace.com/places/' + placeId} data-layout='button_count'></div>
