      ...
      <section className='footer quotefont mobilemarginfooter'>
        <div className='row'>
          ...
          <div className='col-md-4'><h4><span message='footer.social' /></h4><ul className='links'>
            <li><a className='facebook' href='https://www.facebook.com/clearstreet?ref=aymt_homepage_panel' target='_blank'>Facebook</a></li>
            <li><a className='twitter' href='https://twitter.com/clearstreetio' target='_blank'>Twitter</a></li>
